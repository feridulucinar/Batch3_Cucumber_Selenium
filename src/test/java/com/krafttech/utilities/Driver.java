        ...
        if (driverPool.get() == null) {
            ...
            switch (browser) {
                ...
                case "remote_chrome":
                  ...
                  //      driverPool.set(new RemoteWebDriver(new URL("http://54.158.164.163:4444/wd/hub"),chromeOptions));
                ...
                case "remote_firefox":
                    ...
                    //    driverPool.set(new RemoteWebDriver(new URL("http://54.158.164.163:4444/wd/hub"),firefoxOptions));
                    } catch (MalformedURLException e) {
                        e.printStackTrace();
                    }
                    break;
